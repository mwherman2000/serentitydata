...
namespace sdc03.GenCodeMemory03
{
    public class GenCodeMemory03 : IGenCode
    {
        ...
        private string GetTextResource(string resName)
        {
            ...
            _textStreamReader = new StreamReader(_assembly.GetManifestResourceStream("sdc03.GenCodeMemory03.Resources." + resName));
        ...
        public bool GenerateCodeLevel0Basic(NPCCompilerContext ctx, int classIndex)
        {
            ...
            text1 = text1.Replace("#NAMESPACE#", "SerentityData.Runtime.Memory");
        ...
        public bool GenerateCodeLevel4CollectibleExt0(NPCCompilerContext ctx, int classIndex)
        {
            ...
            text = text.Replace("#NAMESPACE#", "SerentityData.Runtime.Memory");
