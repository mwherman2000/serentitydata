...
namespace sdc03.GenCodeNeo03
{
    public class GenCodeNeo03 : IGenCode
    {
        ...
        private string GetTextResource(string resName)
        {
            ...
            _textStreamReader = new StreamReader(_assembly.GetManifestResourceStream("sdc03.GenCodeNeo03.Resources." + resName));
        ...
        public bool GenerateCodeLevel0Basic(NPCCompilerContext ctx, int classIndex)
        {
            ...
            text1 = text1.Replace("#NAMESPACE#", "SerentityData.Runtime.Neo");
        ...
        public bool GenerateCodeLevel4CollectibleExt0(NPCCompilerContext ctx, int classIndex)
        {
            ...
            text = text.Replace("#NAMESPACE#", "SerentityData.Runtime.Neo");
