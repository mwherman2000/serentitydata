...
namespace sdc03.GenCodeStratis03
{
    public class GenCodeStratis03 : IGenCode
    {
        // Reference: https://support.microsoft.com/en-ca/help/319292/how-to-embed-and-access-resources-by-using-visual-c
        private string GetTextResource(string resName)
        {
            string text;
            ...
            _textStreamReader = new StreamReader(_assembly.GetManifestResourceStream("sdc03.GenCodeStratis03.Resources." + resName));
        ...
        public bool GenerateCodeLevel0Basic(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;
            ...
            text1 = GetTextResource(NPCCompilerContext.NeoEntityModel_csName);
            ...
            text1 = text1.Replace("#NAMESPACE#", "SerentityData.Runtime.Stratis");
            text1 = text1.Replace("#CLASSNAME#", "NeoEntityModel");
            File.WriteAllText(targetFullyQualifiedFileName, text1);

            text1 = GetTextResource(NPCCompilerContext.NeoTrace_csName);
            ...
            text1 = GetTextResource(NPCCompilerContext.NPCLevel0Part1_csName);
            text3 = GetTextResource(NPCCompilerContext.NPCLevel0Part2_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
        ...
        public bool GenerateCodeLevel1Managed(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;

            string targetFullyQualifiedFileName = "";
            string text1 = GetTextResource(NPCCompilerContext.NPCLevel1Part1_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string textSetXGetXTemplate = GetTextResource(NPCCompilerContext.NPCLevel1SetXGetX_csName);
            string textSetXGetX = "";
            ...
            string textSetTemplate = GetTextResource(NPCCompilerContext.NPCLevel1Set_csName);
            ...
            string text2Template = GetTextResource(NPCCompilerContext.NPCLevel1Part2_csName);
        ...
        public bool GenerateCodeLevel2Persistable(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;
            ...
            string part1Template = GetTextResource(NPCCompilerContext.NPCLevel2Part1_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string textFieldConstsTemplate = GetTextResource(NPCCompilerContext.NPCLevel2AFieldConsts_csName);
            string allFieldParameters = "";
            string allFieldAssignments = "";
            string allFieldsAssignedZero = "";
            string allFieldArgs = "";
            ...
            string text2bMissingTemplate = GetTextResource(NPCCompilerContext.NPCLevel2BMissing_csName);
            ...
            string text2CPutTemplate = GetTextResource(NPCCompilerContext.NPCLevel2CPut_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text2DPutTemplate = GetTextResource(NPCCompilerContext.NPCLevel2DPut_csName);
            ...
            string text2EPutTemplate = GetTextResource(NPCCompilerContext.NPCLevel2EPut_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text2FGetTemplate = GetTextResource(NPCCompilerContext.NPCLevel2FGet_csName);
            ...
            string text2GGetTemplate = GetTextResource(NPCCompilerContext.NPCLevel2GGet_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text2HGetTemplate = GetTextResource(NPCCompilerContext.NPCLevel2HGet_csName);
            ...
            string text2IGetTemplate = GetTextResource(NPCCompilerContext.NPCLevel2IGet_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string part2Template = GetTextResource(NPCCompilerContext.NPCLevel2Part2_csName);
        ...
        public bool GenerateCodeLevel3Deletable(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;
            ...
            string targetFullyQualifiedFileName = "";
            string part1Template = GetTextResource(NPCCompilerContext.NPCLevel3Part1_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string text3ABuryTemplate = GetTextResource(NPCCompilerContext.NPCLevel3ABury_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text3BBuryTemplate = GetTextResource(NPCCompilerContext.NPCLevel3BBury_csName);
            text = text3BBuryTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            File.AppendAllText(targetFullyQualifiedFileName, text);

            string text3CBuryTemplate = GetTextResource(NPCCompilerContext.NPCLevel3CBury_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string part2Template = GetTextResource(NPCCompilerContext.NPCLevel3Part2_csName);
            string part2 = part2Template.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            File.AppendAllText(targetFullyQualifiedFileName, part2);
        ...
        public bool GenerateCodeLevel4Collectible(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;
            ...
            string part1Template = GetTextResource(NPCCompilerContext.NPCLevel4Part1_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string text4APutElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4APutElement_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4BGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4BGetElement_csName);
            ...
            string allFieldsAssignedZero = "";
            string allFieldArgs = "";
            string text4CGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4CGetElement_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4DBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4DBuryElement_csName);
            ...
            string text4EBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4EBuryElement_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string part2Template = GetTextResource(NPCCompilerContext.NPCLevel4Part2_csName);
        ...
        public bool GenerateCodeLevel4CollectibleExt0(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;
            ...
            text = GetTextResource(NPCCompilerContext.NeoVersionedAppUser_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            text = text.Replace("#NAMESPACE#", "SerentityData.Runtime.Stratis");
            text = text.Replace("#CLASSNAME#", "NeoVersionedAppUser");
            File.WriteAllText(targetFullyQualifiedFileName, text);

            text = GetTextResource(NPCCompilerContext.NeoStorageKey_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string part1Template = GetTextResource(NPCCompilerContext.NPCLevel4Part1Ext0_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string text4APutElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4APutElementExt0_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4BGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4BGetElementExt0_csName);
            text = text4BGetElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            File.AppendAllText(targetFullyQualifiedFileName, text);
            ...
            string allFieldsAssignedZero = "";
            string allFieldArgs = "";
            string text4CGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4CGetElementExt0_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4DBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4DBuryElementExt0_csName);
            text = text4DBuryElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            text = text.Replace("#ALLFIELDPARAMETERS#", allFieldParameters.Substring(0, allFieldParameters.Length - 2)); // drop last ", "
            text = text.Replace("#ALLFIELDSASSIGNEDZERO#", allFieldsAssignedZero);
            text = text.Replace("#ALLFIELDASSIGNMENTS#", allFieldAssignments);
            ...
            string text4EBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4EBuryElementExt0_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string part2Template = GetTextResource(NPCCompilerContext.NPCLevel4Part2Ext0_csName);
            string part2 = part2Template.Replace("#PROGRAMNAME#", Program.ProgramName);
            part2 = part2.Replace("#PROGRAMVERSION#", Assembly.GetEntryAssembly().GetName().Version.ToString());
            part2 = part2.Replace("#NOWDATETIME#", DateTime.Now.ToString());
            part2 = part2.Replace("#NAMESPACE#", ctx.listModuleInfo[0].moduleTargetProjectName);
        ...
        public bool GenerateCodeLevel4CollectibleExt1(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;
            ...
            string part1Template = GetTextResource(NPCCompilerContext.NPCLevel4Part1Ext1_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string text4APutElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4APutElementExt1_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4BGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4BGetElementExt1_csName);
            text = text4BGetElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            File.AppendAllText(targetFullyQualifiedFileName, text);
            ...
            string allFieldsAssignedZero = "";
            string allFieldArgs = "";
            string text4CGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4CGetElementExt1_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4DBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4DBuryElementExt1_csName);
            text = text4DBuryElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            text = text.Replace("#ALLFIELDPARAMETERS#", allFieldParameters.Substring(0, allFieldParameters.Length - 2)); // drop last ", "
            text = text.Replace("#ALLFIELDSASSIGNEDZERO#", allFieldsAssignedZero);
            text = text.Replace("#ALLFIELDASSIGNMENTS#", allFieldAssignments);
            ...
            string text4EBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4EBuryElementExt1_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string part2Template = GetTextResource(NPCCompilerContext.NPCLevel4Part2Ext1_csName);
            string part2 = part2Template.Replace("#PROGRAMNAME#", Program.ProgramName);
            part2 = part2.Replace("#PROGRAMVERSION#", Assembly.GetEntryAssembly().GetName().Version.ToString());
            part2 = part2.Replace("#NOWDATETIME#", DateTime.Now.ToString());
            part2 = part2.Replace("#NAMESPACE#", ctx.listModuleInfo[0].moduleTargetProjectName);
        ...
        public bool GenerateCodeLevel4CollectibleExt2(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;
            ...
            string part1Template = GetTextResource(NPCCompilerContext.NPCLevel4Part1Ext2_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string text4APutElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4APutElementExt2_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4BGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4BGetElementExt2_csName);
            text = text4BGetElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            File.AppendAllText(targetFullyQualifiedFileName, text);
            ...
            string allFieldsAssignedZero = "";
            string allFieldArgs = "";
            string text4CGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4CGetElementExt2_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4DBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4DBuryElementExt2_csName);
            text = text4DBuryElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            text = text.Replace("#ALLFIELDPARAMETERS#", allFieldParameters.Substring(0, allFieldParameters.Length - 2)); // drop last ", "
            text = text.Replace("#ALLFIELDSASSIGNEDZERO#", allFieldsAssignedZero);
            text = text.Replace("#ALLFIELDASSIGNMENTS#", allFieldAssignments);
            ...
            string text4EBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4EBuryElementExt2_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string part2Template = GetTextResource(NPCCompilerContext.NPCLevel4Part2Ext2_csName);
            string part2 = part2Template.Replace("#PROGRAMNAME#", Program.ProgramName);
            part2 = part2.Replace("#PROGRAMVERSION#", Assembly.GetEntryAssembly().GetName().Version.ToString());
            part2 = part2.Replace("#NOWDATETIME#", DateTime.Now.ToString());
            part2 = part2.Replace("#NAMESPACE#", ctx.listModuleInfo[0].moduleTargetProjectName);
        ...
        public bool GenerateCodeLevel4CollectibleExt3(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;
            ...
            string part1Template = GetTextResource(NPCCompilerContext.NPCLevel4Part1Ext3_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string text4APutElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4APutElementExt3_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4BGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4BGetElementExt3_csName);
            text = text4BGetElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            File.AppendAllText(targetFullyQualifiedFileName, text);
            ...
            string allFieldsAssignedZero = "";
            string allFieldArgs = "";
            string text4CGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4CGetElementExt3_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4DBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4DBuryElementExt3_csName);
            text = text4DBuryElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            text = text.Replace("#ALLFIELDPARAMETERS#", allFieldParameters.Substring(0, allFieldParameters.Length - 2)); // drop last ", "
            text = text.Replace("#ALLFIELDSASSIGNEDZERO#", allFieldsAssignedZero);
            text = text.Replace("#ALLFIELDASSIGNMENTS#", allFieldAssignments);
            ...
            string text4EBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4EBuryElementExt3_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string part2Template = GetTextResource(NPCCompilerContext.NPCLevel4Part2Ext3_csName);
            string part2 = part2Template.Replace("#PROGRAMNAME#", Program.ProgramName);
            part2 = part2.Replace("#PROGRAMVERSION#", Assembly.GetEntryAssembly().GetName().Version.ToString());
            part2 = part2.Replace("#NOWDATETIME#", DateTime.Now.ToString());
            part2 = part2.Replace("#NAMESPACE#", ctx.listModuleInfo[0].moduleTargetProjectName);
        ...
        public bool GenerateCodeLevel4CollectibleExt4(NPCCompilerContext ctx, int classIndex)
        {
            bool success = true;
            ...
            string part1Template = GetTextResource(NPCCompilerContext.NPCLevel4Part1Ext4_csName);
            targetFullyQualifiedFileName = ctx.listModuleInfo[0].moduleTargetFullyQualifiedProjectFolder + "\\" +
            ...
            string text4APutElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4APutElementExt4_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4BGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4BGetElementExt4_csName);
            text = text4BGetElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            File.AppendAllText(targetFullyQualifiedFileName, text);
            ...
            string allFieldsAssignedZero = "";
            string allFieldArgs = "";
            string text4CGetElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4CGetElementExt4_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string text4DBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4DBuryElementExt4_csName);
            text = text4DBuryElementTemplate.Replace("#CLASSNAME#", ctx.listClassInfo[classIndex].classOutputName);
            text = text.Replace("#ALLFIELDPARAMETERS#", allFieldParameters.Substring(0, allFieldParameters.Length - 2)); // drop last ", "
            text = text.Replace("#ALLFIELDSASSIGNEDZERO#", allFieldsAssignedZero);
            text = text.Replace("#ALLFIELDASSIGNMENTS#", allFieldAssignments);
            ...
            string text4EBuryElementTemplate = GetTextResource(NPCCompilerContext.NPCLevel4EBuryElementExt4_csName);
            foreach (NPCFieldInfo f in ctx.listFieldInfo)
            {
                if (f.fieldClassIndex == classIndex) // TODO Performance
                {
            ...
            string part2Template = GetTextResource(NPCCompilerContext.NPCLevel4Part2Ext4_csName);
            string part2 = part2Template.Replace("#PROGRAMNAME#", Program.ProgramName);
            part2 = part2.Replace("#PROGRAMVERSION#", Assembly.GetEntryAssembly().GetName().Version.ToString());
            part2 = part2.Replace("#NOWDATETIME#", DateTime.Now.ToString());
            part2 = part2.Replace("#NAMESPACE#", ctx.listModuleInfo[0].moduleTargetProjectName);
        ...
        /// <returns></returns>
        public bool GenerateCodeCustomMethods(NPCCompilerContext ctx, int classIndex, List<NPCClassInterfaceInfo> listClassInterfaces)
        {
            bool success = true;
            ...
            foreach (NPCClassInterfaceInfo cii in listClassInterfaces)
            {
                ...
                {                    
                    ...
                    textTemplate = GetTextResource(resname);
                }
