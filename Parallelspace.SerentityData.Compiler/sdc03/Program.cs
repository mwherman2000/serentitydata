...
namespace sdc03
{
    ...
    class Program
    {
        public const string ProgramName = "SerentityData Compiler (SDC) 3.0 ";
        ...
        static void Main(string[] args)
        {
            ...
            //sdc03.GenCodeMemory03.GenCodeMemory03 codegen = new sdc03.GenCodeMemory03.GenCodeMemory03();
            sdc03.GenCodeNeo03.GenCodeNeo03 codegen = new sdc03.GenCodeNeo03.GenCodeNeo03();
            ...
            foreach (FileInfo fi in di.GetFiles("*.dll"))
            {
                ...
                for (int classIndex = 0; classIndex < ctx.listClassInfo.Count; classIndex++)
                {
                    ...
                    {
                        success = codegen.GenerateCodeLevel0Basic(ctx, classIndex);
                    ...
                    if (listClassInterfaces.Count == 1)
                    {
                        success = codegen.GenerateCodeLevel1Managed(ctx, classIndex);
                    ...
                    if (listClassInterfaces.Count == 1)
                    {
                        success = codegen.GenerateCodeLevel2Persistable(ctx, classIndex);
                    ...
                    if (listClassInterfaces.Count == 1)
                    {
                        success = codegen.GenerateCodeLevel3Deletable(ctx, classIndex);
                    ...
                    if (listClassInterfaces.Count == 1)
                    {
                        success = codegen.GenerateCodeLevel4CollectibleExt0(ctx, classIndex);
                        ...
                        success = codegen.GenerateCodeLevel4CollectibleExt2(ctx, classIndex);
                    ...
                    if (listClassInterfaces.Count >= 1)
                    {
                        success = codegen.GenerateCodeCustomMethods(ctx, classIndex, listClassInterfaces);
